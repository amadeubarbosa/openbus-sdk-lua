...
Para descrever melhor esses passos, mantemos uma página com explicações em \url{https://jira.tecgraf.puc-rio.br/confluence/display/OpenBus/Como+instalar+o+SDK+Lua+e+executar+o+HelloService+(v+1.5.3)}.

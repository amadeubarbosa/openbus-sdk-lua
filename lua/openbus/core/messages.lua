...
msg.InvokeWithCredential = "chamando operação '$operation' com credencial de '$entity' ($login)"
msg.GrantedCallWithoutCallerInfo = "autorizada chamada de '$operation' sem credencial"
msg.GrantedCall = "autorizada chamada de '$operation' por '$entity' ($login)"
msg.DeniedCall = "negada chamada de '$operation' por '$entity' ($login)"
msg.GotInvalidCaller = "chamando operação '$operation' com credencial inválida de '$entity' ($login)"

...
---
REGISTRY_SERVICE_INTERFACE = "IDL:tecgraf/openbus/core/"..IDL_VERSION..
    "/registry_service/IRegistryService:1.0"

---
--  A interface IRegistryService utilizada na versão anterior.
---
REGISTRY_SERVICE_INTERFACE_PREV = "IDL:openbusidl/rs/IRegistryService:1.0"

---
--  A chave para obtenção do barramento.
---
OPENBUS_KEY = "openbus_" .. IDL_VERSION
OPENBUS_KEY_PREV = "openbus_" .. IDL_PREV

---
--  As chaves CORBALOC para obtenção das interfaces do ACS.
---
ACCESS_CONTROL_SERVICE_KEY = "ACS_"..IDL_VERSION
ACCESS_CONTROL_SERVICE_KEY_PREV = "ACS"
LEASE_PROVIDER_KEY = "LP_"..IDL_VERSION
LEASE_PROVIDER_KEY_PREV = "LP"
FAULT_TOLERANT_ACS_KEY = "FTACS_"..IDL_VERSION
MANAGEMENT_KEY = "MGM_"..IDL_VERSION

---
--  As chaves CORBALOC para obtenção das interfaces do RS.
---
REGISTRY_SERVICE_KEY = "RS_"..IDL_VERSION
REGISTRY_SERVICE_KEY_PREV = "RS"
FAULT_TOLERANT_RS_KEY = "FTRS_"..IDL_VERSION
FT_RS_MONITOR_KEY = "FTRSMonitor_"..IDL_VERSION
MANAGEMENT_RS_KEY = "MGMRS_" .. IDL_VERSION

---
--  A interface ISessionService.
---
SESSION_SERVICE_INTERFACE = "IDL:tecgraf/openbus/session_service/"..IDL_VERSION..
    "/ISessionService:1.0"

---
--  A interface ISessionService utilizada na versão anterior.
---
SESSION_SERVICE_INTERFACE_PREV = "IDL:openbusidl/ss/ISessionService:1.0"

---
--  A interface SessionEventSink.
---
SESSION_ES_INTERFACE = "IDL:tecgraf/openbus/session_service/"..IDL_VERSION..
    "/SessionEventSink:1.0"

---
--  A interface SessioneventSink utilizada na versão anterior.
---
SESSION_ES_INTERFACE_PREV = "IDL:openbusidl/ss/SessionEventSink:1.0"

---
--  A interface ISession.
---
SESSION_INTERFACE = "IDL:tecgraf/openbus/session_service/"..IDL_VERSION..
  "/ISession:1.0"

---
--  A interface ISession utilizada na versão anterior.
---
SESSION_INTERFACE_PREV = "IDL:openbusidl/ss/ISession:1.0"

---
--  A interface ICredentialObserver.
---
CREDENTIAL_OBSERVER_INTERFACE = "IDL:tecgraf/openbus/core/"..IDL_VERSION..
    "/access_control_service/ICredentialObserver:1.0"

---
--  A interface ICredentialObserver utilizada na versão anterior.
---
CREDENTIAL_OBSERVER_INTERFACE_PREV = "IDL:openbusidl/acs/ICredentialObserver:1.0"

---
--  A interface IManagement do Servico de Controle de Acesso.
---
MANAGEMENT_ACS_INTERFACE =  "IDL:tecgraf/openbus/core/" .. IDL_VERSION ..
  "/access_control_service/IManagement:1.0"

---
--  A interface IManagement do Servico de Registro.
---
MANAGEMENT_RS_INTERFACE =  "IDL:tecgraf/openbus/core/" .. IDL_VERSION ..
  "/registry_service/IManagement:1.0"

---
--  O nome da faceta do Serviço de Sessão.
---
SESSION_SERVICE_FACET_NAME = "ISessionService_" .. IDL_VERSION
...
function fetchAccessControlService(orb, host, port)
  ...
  if not OilUtilities:existent(acs) then
    Log:error(format("A faceta IAccessControlService_%s não foi encontrada", IDL_VERSION))
    error()
  end
